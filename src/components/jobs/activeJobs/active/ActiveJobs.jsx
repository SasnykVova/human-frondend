...
import s from './ActiveJobs.module.scss';
        ...
        <div className={s.jobs} >
            <div className={s.itemBlock}>
                {state.getJobs.loading
                    ...
                    : 
                    state.vacancyData.filter(v => v.status === 'ACTIVE').map(v => <NavLink to={`/jobs/activejobs/`}><Vacancy key={v.id} _id={v._id} assignedTo={v.assignedTo
